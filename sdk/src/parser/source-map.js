...
export class SourceMapHandler {
    ...
    init(sourceMap) {
        return new Promise((resolve, reject) => {
            const mapData = typeof sourceMap === 'string' ? JSON.parse(sourceMap) : sourceMap;
 ...
 */
export function lineColumnToOffset(content, line, column) {
    let offset = 0;
    let currentLine = 1;
    let currentColumn = 0;

...
export interface CaptureConfig {
  ...
  /**
   * Sampling rate as a percentage (0-100) - percentage of traces to capture (default: 100)
   */
  samplingRate?: number;

  /**
   * Maximum timeout in milliseconds for serialization (default: 5000)
   */
...
export interface CapturedVariables {
  ...
  /**
   * Whether this trace was sampled out (not captured)
   */
  sampledOut?: boolean;

  /**
   * Whether serialization timed out
   */
  timedOut?: boolean;
}
